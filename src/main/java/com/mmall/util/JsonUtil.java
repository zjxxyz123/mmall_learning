...
public class JsonUtil {
    ...
    static{
        ...
        //取消 转换timestamps形式:从1970年到现在的毫秒数（默认是true）
    ...
    //用于反序列 List<User>，Map<User,Category>
    //eg:JsonUtil.string2Obj(userListStr, new TypeReference<List<User>>() {
//        });
    ...
    //用于反序列 List<User>，Map<User,Category>:
    //eg: JsonUtil.string2Obj(userListStr,List.class,User.class);
